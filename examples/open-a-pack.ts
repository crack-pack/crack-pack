import { lea, openPack, openPacks } from '../src/index.ts';
...
console.log(`\n=== Opening one ${lea.name} pack${seed !== undefined ? ` (seed ${seed})` : ''} ===\n`);
const pack = openPack(lea, seed !== undefined ? { seed } : {});
...
const box = openPacks(lea, 36, { seed: 2026 });
